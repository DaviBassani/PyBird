...
IMAGENS_PASSARO =[
    pygame.transform.scale2x(pygame.image.load(os.path.join(r'/home/bassani/Documentos/python/FlappyBird/imgs/bird1.png'))),
    pygame.transform.scale2x(pygame.image.load(os.path.join(r'/home/bassani/Documentos/python/FlappyBird/imgs/bird2.png'))),
    pygame.transform.scale2x(pygame.image.load(os.path.join(r'/home/bassani/Documentos/python/FlappyBird/imgs/bird3.png')))
]

pygame.font.init()
FONTE_PONTOS = pygame.font.SysFont('alegrian', 50)
